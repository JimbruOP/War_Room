...
// NewsData free tier: 200 credits/day, 1 credit per query. Quota resets 00:00 UTC.
export const NEWSDATA_DAILY_LIMIT = 200;
// Cost of one manual "Refresh now" (the core/Kerala tier).
export const CORE_QUERY_COUNT = 5;
