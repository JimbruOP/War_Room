...
export function generateCaptions({ lens, source, style }) {
  return postJson("/api/caption", { lens, source, style });
}

export function translateCaption(text) {
  return postJson("/api/caption/translate", { text });
}
